...
#model_name = "saved_dir/checkpoint-748"
model_name = "saved_dir_qwen3_prompt2_aug"
...
data = []
#file_test = "data/raw/duration_public_test.txt"
file_test = "data/raw/private_test.txt"
...
df_test.to_csv("submit_private/inference_qwen3_prompt2_aug.csv", index=False)
print(df_test)
